...
namespace UserManagementService.Shared.Core.Aggregate.Specification
{
    public static class Extensions
    {
        ...
        public static void ApplySorting(this IRootSpecification gridSpec, string sort, string orderByDescendingMethodName, string groupByMethodName)
        {
