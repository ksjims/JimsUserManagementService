...
COPY . .
RUN dotnet build "LambdaInDocker.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "LambdaInDocker.csproj" \
...
Execute unit tests
```
cd "LambdaInDocker/test/LambdaInDocker.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "LambdaInDocker/src/LambdaInDocker"
